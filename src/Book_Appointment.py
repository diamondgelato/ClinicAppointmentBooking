...
def bookAppointmentScreen (root):
    def getAppointment ():
        timeframe = tk.Frame(newWind, padx=10, pady=10, bg="lightblue")
    ...
    frame = tk.LabelFrame (newWind, padx=10, pady=10, bg="lightblue", text='Please enter your details for booking the appointment')
    frame.grid(row=0, column=0, sticky='news')

    frame2=tk.Frame (newWind, padx=10, pady=10, bg="white")
